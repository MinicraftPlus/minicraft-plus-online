...
public class MinicraftClient extends MinicraftConnection {
	...
	public MinicraftClient(String username, String token, MultiplayerDisplay menu, String hostName) { this(username, token, menu, hostName, DEFAULT_CONNECT_TIMEOUT); }
	public MinicraftClient(String username, String token, MultiplayerDisplay menu, String hostName, int connectTimeout) {
	...
	private void changeState(State newState) {
		...
		switch(newState) {
			case LOGIN: sendData(InputType.LOGIN, ((RemotePlayer)Game.player).getUsername()+ ";" + ((RemotePlayer)Game.player).getToken() + ";" +Game.VERSION); break;
	...
	private void login(String username, String token) {
		...
		try {
			...
			((RemotePlayer)Game.player).setToken(token);
		} catch(UnknownHostException ex) {
